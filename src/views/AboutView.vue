<template>
  <div class="about">
    ...
    <h1 class="title" style="margin-top: 50px">About the Vermont Livability Map</h1>
      ...
      <p>
        Key partners who provided additional staffing to organize and lead sub-teams included Kendall Fortney of the <a href="https://verso.w3.uvm.edu/" target="_blank">Vermont Open Source Research Office (VERSO)</a> at the <a href="https://uvm.edu/" target="_blank">University of Vermont</a>, Catherine Dimitruk of the <a href="https://www.nrpcvt.com/" target="_blank">Northwest Regional Planning Commission</a>, and Leslie Black-Plumeau of the <a href="https://vhfa.org/" target="_blank">Vermont Housing Finance Agency</a>. Significant funding for student interns was provided by the <a href="https://www.uvm.edu/cas/geography" target="_blank">University of Vermont Geography and Geosciences Department</a>, <a href="https://www.uvm.edu/gund" target="_blank">Gund Fund for the Environment</a>, the College of Arts & Sciences Fellowship program and an anonymous donation which supported the UVM ORCA Student internship teams for over a year.
      </p>
      <p>
      ...
      <img alt="ORCA at Work" src="@/assets/classwork.png"/>
      <p><br>
      ...
      <p>
        The Vermont Livability map is partially funded by the Afred P. Sloan Foundation and the Vermont Community Fund along with support for the Vermont Zoning Atlas and the Wastewater Infrastructure Map Project 
      </p>
    </div>
  </div>
</template>
